...
class SCTCTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        for i in range(ngroups):
            ...
            loss = F.ctc_loss(log_probs, flattened_targets, input_lengths, target_lengths, blank=model.config.pad_token_id, zero_infinity=True, reduction=model.config.ctc_loss_reduction)
